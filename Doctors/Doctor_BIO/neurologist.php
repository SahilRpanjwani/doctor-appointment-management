...
<head>
    ...
    <title>Neurologists - Doctor Appointment Management</title>
    <style>
        body {
        ...
        .content {
            ...
            padding: 20px;
            position: relative;
            background: url('neurologist-background.jpg') no-repeat center center;
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="content-overlay">
                <h2>Top Neurologists in Your Area</h2>
                <p>Looking for expert care for neurological conditions? Our platform offers top-rated neurologists for various treatments related to the brain, spine, and nerves.</p>

                <!-- Services Section -->
                <section class="services">
                    <h3 class="highlight">Neurologist Services Offered</h3>
                    <ul>
                        <li>Stroke Treatment and Prevention</li>
                        <li>Epilepsy and Seizure Management</li>
                        <li>Migraines and Headache Treatment</li>
                        <li>Parkinson’s Disease Care</li>
                ...
                <section class="reviews">
                    ...
                    <p>"Dr. Emily Brown's care for my migraines was life-changing. Highly recommend!" - <em>Sarah Collins</em></p>
                    <p>"Dr. John Miller helped manage my epilepsy effectively. Best neurologist I've seen!" - <em>David Green</em></p>
                </section>

                <!-- Booking Section -->
                <section class="book-section">
                    <h3 class="highlight">Ready to Book an Appointment?</h3>
                    <p>Click the button below to find a neurologist and schedule your appointment today.</p>
                    <a href="book_appointment.php?doctor=neurologist" class="book-btn">Book a Neurologist Appointment</a>
                </section>
            </div>
        </div>
    </div>
