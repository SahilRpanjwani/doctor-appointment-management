...
<head>
    ...
    <title>Cardiologists - Doctor Appointment Management</title>
    <style>
        body {
        ...
        .content {
            ...
            padding: 20px;
            position: relative;
            background: url('cardiologist-background.jpg') no-repeat center center;
...
<body>
    ...
    <header>
        <h1>Cardiologist Specialists</h1>
        <nav>
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="content-overlay">
                <h2>Top Cardiologists in Your Area</h2>
                <p>Looking for expert cardiovascular care? Our platform offers top-rated cardiologists for a variety of heart-related conditions.</p>

                <!-- Services Section -->
                <section class="services">
                    <h3 class="highlight">Cardiologist Services Offered</h3>
                    <ul>
                        <li>Heart Disease Diagnosis</li>
                        <li>Cardiac Stress Testing</li>
                        <li>ECG and Echocardiogram Services</li>
                ...
                <section class="reviews">
                    ...
                    <p>"Dr. Emily Clark saved my life. I am forever grateful for the excellent care I received." - <em>Sam Roberts</em></p>
                    <p>"I felt confident and comfortable with Dr. Mark Johnson during my treatment." - <em>Anna Williams</em></p>
                </section>

                <!-- Booking Section -->
                <section class="book-section">
                    <h3 class="highlight">Ready to Book an Appointment?</h3>
                    <p>Click the button below to find a cardiologist and schedule your appointment today.</p>
                    <a href="book_appointment.php?doctor=cardiologist" class="book-btn">Book a Cardiologist Appointment</a>
                </section>
            </div>
        </div>
    </div>
