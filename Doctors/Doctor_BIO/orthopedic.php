...
<head>
    ...
    <title>Orthopedic Specialists - Doctor Appointment Management</title>
    <style>
        body {
        ...
        .content {
            ...
            padding: 20px;
            position: relative;
            background: url('orthopedic-background.jpg') no-repeat center center;
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="content-overlay">
                <h2>Top Orthopedic Specialists in Your Area</h2>
                <p>Looking for expert orthopedic care? Our platform offers top-rated orthopedic specialists for various treatments related to bones, joints, and muscles.</p>

                <!-- Services Section -->
                <section class="services">
                    <h3 class="highlight">Orthopedic Services Offered</h3>
                    <ul>
                ...
                <section class="reviews">
                    ...
                    <p>"Dr. Jane Doe was incredibly knowledgeable and helped me recover from my knee surgery." - <em>John Smith</em></p>
                    <p>"I highly recommend Dr. Sarah Johnson for any orthopedic issues. She is fantastic!" - <em>Emily Davis</em></p>
                </section>

                <!-- Booking Section -->
                <section class="book-section">
                    <h3 class="highlight">Ready to Book an Appointment?</h3>
                    <p>Click the button below to find an orthopedic specialist and schedule your appointment today.</p>
                    <a href="book_appointment.php?doctor=orthopedic" class="book-btn">Book an Orthopedic Appointment</a>
                </section>
            </div>
        </div>
    </div>
